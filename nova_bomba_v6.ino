...
void CountSecondTimer() {
    ...
    if (detonatorActive && (currentMillis - detonatorStartTime >= detonatorDuration)) {
        ...
        if (DEBUG_MODE) {
            Serial.println("Detonator deactivated after 5 seconds");
        }
    }
        ...
        if (currentSecond < 0) {
            ...
            if (currentMinute < 0) {
                ...
                if (!successState) {
                    ...
                    if (DEBUG_MODE) {
                        Serial.println("DETONATOR ACTIVATED! Pin 9 set to HIGH for 5 seconds");
                    }
                } else if (DEBUG_MODE) {
                    Serial.println("Bomb successfully defused! Detonator not activated.");
                }
